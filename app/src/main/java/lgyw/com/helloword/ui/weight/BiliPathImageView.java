...
public class BiliPathImageView extends ImageView{
    ...
    public BiliPathImageView(Context context) {
        super(context);
        init();
        executorService = Executors.newFixedThreadPool(10);
    }

    public BiliPathImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BiliPathImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
